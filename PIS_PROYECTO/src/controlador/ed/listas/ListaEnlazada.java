...
//            }
    ...
    public void imprimir() throws ListaNullException {
        if (estaVacia()) {
    ...
    public E delete(Integer pos) throws ListaNullException, PosicionNoEncontradaException {
        if (estaVacia()) {
            throw new ListaNullException();
        } else {
            E dato = null;
    ...
    public void modificar(Integer pos, E dato) throws ListaNullException, PosicionNoEncontradaException {
        if (estaVacia()) {
            throw new ListaNullException();
        } else {
            if (pos >= 0 && pos < size()) {
